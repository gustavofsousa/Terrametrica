...
| Sistema de referência de coordenadas | SIRGAS 2000 (EPSG:4674) para armazenamento; Web Mercator (EPSG:3857) para exibição | Padrão oficial brasileiro para armazenamento; Mercator é o que as bibliotecas de tile esperam. Confirmado na Fase 0 (2026-09-03): SIGEF já vem em EPSG:4674 nativo; SIGeo Niterói vem em EPSG:31983 e é reprojetado na ingestão. | y |
