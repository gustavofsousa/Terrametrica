...
(rural em todo o estado, urbano no município de Niterói), monta um dossiê com ficha técnica e
...
- Urbano: apenas o município de Niterói, via SIGeo (ArcGIS Hub, com WFS/WMS/GeoJSON).
- Escolha do usuário. Niterói tem a infraestrutura de dados mais favorável do estado a ingestão automatizada.
...
- Corretor, incorporador e investidor → camada urbana de Niterói, foco em restrição de uso e risco.
...
### Agent's Discretion
- O recorte rural/urbano foi delegado ("sem preferência") e decidido como acima. O município piloto foi definido pelo usuário: Niterói.
...
- Município do Rio de Janeiro como segundo município urbano.
- App móvel nativo.
